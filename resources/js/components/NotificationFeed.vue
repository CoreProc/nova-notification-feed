...
<div>
    ...
    <div v-show="isNotificationsPanelVisible">
        <notifications-panel :unread-count="unreadCountBuffer" @toggleNotificationsPanel="toggleNotificationsPanel" @showUnreadNotificationCount="showUnreadNotificationCount" @incrementUnreadCount="incrementUnreadCount" v-bind:broadcast-on="this.broadcastOn">
        </notifications-panel>
    </div>
</div>
</template>
...
export default {
    ...
    methods: {
        ...
        showUnreadNotificationCount: function(unreadCount) {
            ...
            this.unreadCountBuffer = unreadCount
        },
        incrementUnreadCount: function() {
            this.unreadCount += 1
            this.unreadCountBuffer += 1
        },
    }
}
</script>
